...
const group = 'Cms CLI essentials';

export const commands: CommandType[] = (
  [
    {
      title: 'hello world Cms',
      exec: ({ vscode }) => {
        vscode.window.showInformationMessage('Hello World! Cms');
      },
    },
    {
      title: 'hey Cms! show platform',
      exec: ({ vscode }) => {
        vscode.window.showInformationMessage(
          `Cms platform is "${process.platform}"`,
        );
      },
    },
  ] as CommandType[]
